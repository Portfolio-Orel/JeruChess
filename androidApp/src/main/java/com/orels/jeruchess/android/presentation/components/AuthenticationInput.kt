    ...
    Row(modifier = modifier) {
        OutlinedTextField(
            ...
            colors = TextFieldDefaults.textFieldColors(
                focusedIndicatorColor = MaterialTheme.colors.onBackground.copy(alpha = 0.2f),
                unfocusedIndicatorColor = MaterialTheme.colors.onBackground.copy(alpha = 0.2f),
                errorIndicatorColor = MaterialTheme.colors.error,
                textColor = MaterialTheme.colors.onBackground,
                backgroundColor = MaterialTheme.colors.background.copy(alpha = 0.6f),
                cursorColor = MaterialTheme.colors.onBackground,
                focusedLabelColor = MaterialTheme.colors.onBackground.copy(alpha = 0.5f),
            ),
